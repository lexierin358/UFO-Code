...
if ( puzzle == "stand1"):
# ------ SOUND CARD BOX 1 -----
    sndA = pygame.mixer.Sound("Thunder.wav")
    sndB = pygame.mixer.Sound("Waves.wav")
    sndC = pygame.mixer.Sound("Sheep.wav")
    sndD = pygame.mixer.Sound("Train.wav")
    sndE = pygame.mixer.Sound("Saw.wav")
    
elif (puzzle == "stand2"):
# ------ SOUND CARD BOX 2 -----
    sndA = pygame.mixer.Sound("Tractor.wav")
    sndB = pygame.mixer.Sound("LightRain.wav")
    sndC = pygame.mixer.Sound("Horn.wav")
    sndD = pygame.mixer.Sound("Heartbeat.wav")
    sndE = pygame.mixer.Sound("Jet.wav")
