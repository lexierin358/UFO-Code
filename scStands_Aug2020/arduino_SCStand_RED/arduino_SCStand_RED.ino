...
#define ButtonPin_1 7
#define ButtonPin_2 8
#define ButtonPin_3 9
#define ButtonPin_4 10
#define ButtonPin_5 11
...
bufferVal[10] = digitalRead(RedButtonPin);
...
// -----------------CARD # 5 ---------------------
    ...
    else if (Comp("RED_PRESS")==0) {
        //Serial.println("1 INSERTED");
        redPressed = true;
        digitalWrite(RedLedPin,HIGH);
    }
    
    else if (Comp("RED_RESET")==0) {
        //Serial.println("1 REMOVED");
        redPressed = false;
        digitalWrite(RedLedPin,LOW); 
    }
